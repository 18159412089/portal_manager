...
(function($) {
	...
	$.getDateTimeByOffsetDays = function(date, offsetDays, formatStr){
	    var format = formatStr==null || formatStr=='' || formatStr==undefined ? 'yyyy-MM-dd hh:mm:ss' : formatStr;
		var lastOrNextDate = date.getTime() + 1000 * 60 * 60 * 24 * offsetDays;
	    date.setTime(lastOrNextDate);
