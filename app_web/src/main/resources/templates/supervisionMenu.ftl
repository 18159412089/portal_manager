...
<div id="pf-hd" style="position: absolute;width:100%;">
    ...
    <div  class="nav-container">
        <div class="nav-box">
            ...
            <li>
                <a href="${request.contextPath}/environment/rectifition/show?authority=1" target="_self">
                    <i class="icon iconcustom icon-zichan3"></i>
                    <div class="title">总体情况</div>
                </a>
            </li>
            <li>
                <a href="${request.contextPath}/environment/rectifition/rectifitionListIntex?authority=1" target="_self">
                    <i class="icon iconcustom icon-zichan3"></i>
                    <div class="title">整改汇总表</div>
                </a>
            </li>
            <li>
                <a href="${request.contextPath}/environment/envCancellationAccount/show?authority=1" target="_self">
                    <i class="icon iconcustom icon-zichan3"></i>
            ...
            <li>
                <a href="${request.contextPath}/environment/envCancellationAccount/index?authority=1" target="_self">
                    <i class="icon iconcustom icon-zichan3"></i>
            ...
            <li>
                <a href="${request.contextPath}/debrief/StandingBook?authority=1" target="_self">
                    <i class="icon iconcustom icon-zichan3"></i>
