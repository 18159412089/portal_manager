...
<#--<link rel="stylesheet" href="${request.contextPath}/static/plugin/jquery-easyui/themes/default/easyui.css"/>-->
    ...
    <script src="${request.contextPath}/static/plugin/jquery-easyui/plugins/jquery.wunit.js"></script>
   ...
   <script src="${request.contextPath}/static/layer/layer.js"></script>
    ...
    <!-- 自定义js -->
    <script src="${request.contextPath}/static/common/global.js"></script>
    <script src="${request.contextPath}/static/common/amsutil.min.js"></script>
    <script src="${request.contextPath}/static/common/Ams.js"></script>

    <script src="${request.contextPath}/static/common/Ajax.js"></script>
    ...
    <base contextPath="${request.contextPath}" />
