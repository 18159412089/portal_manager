...
<div class="home-air-container">
    ...
    <div class="home-layout fl" id="home-left">
        ...
        <div class="home-panel" id="personnel">
            ...
            <!--面板主内容-->
            <div class="personnel-list-container" id="root">
            </div>
            <!--面板主内容 over-->
        </div>
        <!--首页面板 over-->
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        /*------------------------地图初始化--------------------------------*/
        var longitude = "117.61941799376343";
        var latitude = "23.79512238745895";
    ...
    function getUserInfo() {
        clearMapPoint();
        var url = 'https://140.237.73.123:8092/JointServiceBase/JointServiceBaseUserInfo.service?getComponentTreeUserListForDataCenter&departmentId=3tv6x_GDVbBqcs6q2OwLlq&_REQUEST_SOURCE=MOBILE';
        var text = "";
        var name = 'name';
    ...
    function getGoupList() {
        var url = 'https://140.237.73.123:8092/JointServiceBase/JointServiceBaseUserInfo.service?getComponentTreeDepartmentListForDataCenterOther&departmentId=1NAICIZvh8UEviyYkdCkdq&_REQUEST_SOURCE=MOBILE';
        $.ajax({
            type: "Get",
            url: url,
            dataType: 'json',
    ...
    function getNextLevel(pid) {
        ...
        var url = 'https://140.237.73.123:8092/JointServiceBase/JointServiceBaseUserInfo.service?getComponentTreeUserListForDataCenter&_REQUEST_SOURCE=MOBILE&departmentId=' + pid;
        var name = 'name';
        $.ajax({
            type: "Get",
            url: url,
                ...
                clientRTC.join( // 加入频道
                    ...
                    function (uid) {
                        ...
                        clientRTC.on('stream-subscribed', function (evt) {
                            ...
                            console.log('=====订阅远程音视频流成功: remote_id = ' + remoteStream.getId() + "  local_id = " + uid);
                            // 显示远程视频播放<div>标签id名
