...
<script type="text/javascript">  
    ...
    $(function () {
    	...
    	/*简单循环滚动-开始*/
    	var loopScrollOdj1 = new loopScrollOdj("waterMonitoring",50,40);
    	var loopScrollOdj2 = new loopScrollOdj("monitoringDetails",50,40);
    	var loopScrollOdj3 = new loopScrollOdj("provinceRanking",50,40);
    	var loopScrollOdj4 = new loopScrollOdj("countyRanking",50,40);
