    ...
    <div class="nav-container">
        <div class="nav-box">
            <ul class="nav-ul-tag">
                ...
                <li>
                    <a href="${request.contextPath}/environment/attach/environmentAttachDisplay" target="_self">
                        <i class="icon iconcustom icon-zichan3"></i>
                        <div class="title">总体情况</div>
                    </a>
                </li>
                <li>
                    <a href="${request.contextPath}/environment/attach/environmentAttachTask" target="_self">
                        <i class="icon iconcustom icon-zichan3"></i>
