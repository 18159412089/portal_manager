...
<div class="easyui-layout" fit=true >
    ...
    <div id="toolbar">
        ...
        <form id="uplodFile" method="post" enctype="multipart/form-data">
            <a href="#" class="easyui-linkbutton btn-orange" data-options="iconCls:'icon-add'" onclick="newInfo()" >新增</a>
            <a href="#" class="easyui-linkbutton btn-blue" data-options="iconCls:'icon-edit'" onclick="editInfo()">修改</a>
            ...
            <tr>
                ...
                <td class="con">
                    <input class="easyui-combobox" name="wryzl" value="${pointCode!}" id="regionName"
                           data-options="
									url:'${request.contextPath}/env/pollution2/data/getType?flag=wryzl',
									method:'post',
									editable:false,
									valueField:'name',
						            textField:'name',
            ...
            <tr>
                ...
                <td class="con">
                    <input class="easyui-combobox" name="wrylx" value="${pointCode!}" id="regionName"
                           data-options="
									url:'${request.contextPath}/env/pollution2/data/getType?flag=wrylx',
									method:'post',
									editable:false,
									valueField:'name',
						            textField:'name',
...
<script>
    ...
    function doSearch() {
        $('#dg').datagrid({
            url: "/env/pollution2/data/getInfoPage",
            queryParams: {
