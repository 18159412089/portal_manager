                  ...
                  <div class="legend  alone-legend">
                      <ul class="list">
                          ...
                          <li class="legend-item" data-status="1" data-grade="2" selected="selected">
                              <span class="bg-status-1" style="background-color: #1d58f9;"><span></span></span><span class="title">Ⅲ</span></li>
                      </ul>
                  </div>
              </div>
        ...
        <div class="map-panel-body" style="height: 550px; width: 400px; position: relative; background: none;">
            ...
            <div class="tabs-content" style="width:280px;margin-left:120px; top: 180px;">
                        ...
                        <div class="theme-content">
                            <div class="search-container" id="outfallToolbar">
                                <div class="search-box">
                                    ...
                                    <select name="discharge" id="discharge" class="easyui-combobox alone-combobox" data-placement="全部"
                ...
                <div class="body-box" id="mapTabs_wpfsqy" url="/enviromonit/water/nationalSurfaceWater/getWpfsqyList">
                    <div class="theme-container">
                        <div class="theme-title">筛选<a href='/enviromonit/water/wastewaterCompanySet?pid=${pid!}'  class="title-link-tag" target="_blank">废水企业信息配置>></a></div>
                        <div class="theme-content">
                ...
                <div class="body-box" id="mapTabs_reservoir"
                     url="/enviromonit/water/nationalSurfaceWater/getReservoirPointsList">
                    <div class="theme-container">
                        <div class="theme-title">筛选</div>
                        <div class="theme-content">
                ...
                <div class="body-box" id="mapTabs_miniMonitor"
                     url="/enviromonit/water/nationalSurfaceWater/getMiniMonitorList">
                    <div class="theme-container">
                        <div class="theme-title">筛选</div>
                        <div class="theme-content">
                ...
                <div class="body-box" id="mapTabs_basin"
                     url="/enviromonit/water/nationalSurfaceWater/getBasinMonitorList">
                    <div class="theme-container">
                        <div class="theme-title">筛选</div>
                        <div class="theme-content">
                            ...
                            <div class="search-container" id="gridCaseToolbar">
                                <div class="search-box">
                                    ...
                                    <div style="margin-top:7px;" class="alone-box">
                                        ...
                                        <a href="javascript:void(0)" title="搜索" class="easyui-linkbutton"
            ...
            <!-- <div class="tabs-content"
                ...
                <div style="display: none" class="body-box panel-group-container"
                    ...
                    <table id="wpfsqyDg" class="easyui-datagrid"
                           style="width: 100%; height: auto;" toolbar="#wpfsqyToolbar"
                           url=""
                           data-options="
                            rownumbers:false,
                            singleSelect:true,
...
<script type="text/javascript"
        src="${request.contextPath}/static/js/moudles/enviromonit/water/nationalSurfaceWater.js"></script>
...
<script type="text/javascript"
        src="${request.contextPath}/static/js/moudles/enviromonit/water/outfallAnalysis.js"></script>
<script type="text/javascript"
        src="${request.contextPath}/static/js/moudles/enviromonit/water/reservoirAnalysis.js"></script>
<script type="text/javascript" src="${request.contextPath}/static/js/moudles/enviromonit/water/policy.js"></script>
<script type="text/javascript"
        src="${request.contextPath}/static/js/moudles/enviromonit/water/basinAnalysis.js"></script>
<script type="text/javascript"
        src="${request.contextPath}/static/js/moudles/enviromonit/water/wpfsqyAnalysis.js"></script>
...
<!-- 网格事件js -->
<script type="text/javascript" src="${request.contextPath}/static/js/moudles/enviromonit/water/waterCase.js"></script>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function initMapSurfaceWater() {
            var longitude = "117.54124090035458";
            var latitude = "24.4656204502125";
            map = initMap({
                target: "mapDiv",
        ...
        $.ajax({
            ...
            complete:function(){loadDeviceList();
            },
            dataType: 'json'
        });
        ...
        if (waterPointCode != "") {
            $.ajax({
                type: "post",
                url: "/enviromonit/water/nationalSurfaceWater/getListByPointCode",
                async: true,
                data: {
    ...
    function  loadBasinData(){
        if(Ams.isNoEmpty($("#basinCode").val())){
            $.ajax({
                type: "post",
                url: "/enviromonit/water/nationalSurfaceWater/getListByBasinCode",
                async: true,
                data: {
