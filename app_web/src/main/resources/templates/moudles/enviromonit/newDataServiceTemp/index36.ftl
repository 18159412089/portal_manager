...
<div class="easyui-layout p10" >
    ...
    <div id="searchBar1" class="searchBar">
        <form id="searchForm1">
            ...
            <a href="javascript:void(0)" onclick="Ams.exportPdfById('group0','监测站污染物-同比')" class="easyui-linkbutton btn-blue" data-options="iconCls:'iconcustom icon-shujudaochu1'">导出数据</a>
...
<script>
    ...
    $("#regionName").combobox({
        ...
        onSelect: function (obj) {
            $("#pointName").combobox({
                url: "${request.contextPath}/enviromonit/airMonitorPoint/getPointByCity?parent="+obj.uuid+"&getAll=false",
                valueField: "uuid",
                textField: "name",
                panelHeight: "auto",
                prompt:"全部",
	...
	function getPointName(){
		var regionName = $('#pointName').combobox('getValues');
