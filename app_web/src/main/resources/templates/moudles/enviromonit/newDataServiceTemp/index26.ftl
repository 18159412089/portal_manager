			...
			<div class="easyui-layout" fit=true>
				...
				<div id="toolbar1">
				    ...
				    <div class="optionBar">
				    	...
				    	<!-- 单选按钮组 over-->
				    	<a href="javascript:void(0)" class="easyui-linkbutton btn-blue"  onClick=" Ams.exportPdfById('waterAnalysis','均值分析(国控)')" data-options="iconCls:'iconcustom icon-shujudaochu1'">导出图片</a>
				    </div>
			...
			<div class="easyui-layout" fit=true>
				...
				<div id="toolbar2">
				    ...
				    <div class="optionBar">
				    	...
				    	<!-- 单选按钮组 over-->
				    	<a href="javascript:void(0)" class="easyui-linkbutton btn-blue"  onClick=" Ams.exportPdfById('waterAnalysis1','均值分析（省控）')" data-options="iconCls:'iconcustom icon-shujudaochu1'">导出图片</a>
				    </div>
