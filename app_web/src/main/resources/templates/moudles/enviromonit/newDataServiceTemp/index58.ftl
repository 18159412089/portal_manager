...
<div class="easyui-layout p10" >
    ...
    <div id="searchBar1" class="searchBar">
        <form id="searchForm1">
            ...
            <#--<a href="javascript:void(0)" class="easyui-linkbutton btn-blue" data-options="iconCls:'iconcustom icon-shujudaochu1'" onclick="exportImage()">导出数据</a>-->
            <a href="javascript:void(0)" onClick=" Ams.exportPdfById('airPrimaryPollutant','超标天数(同比)')"  class="easyui-linkbutton btn-blue" data-options="iconCls:'iconcustom icon-shujudaochu1'">导出图片</a>
        </form>
    ...
    <div class="chart-group">
        ...
        <div class="data-info-layout ">
            ...
            <div class="row">
                ...
                <div class="item col-xs-4">
                    <div class="cell-title" id="datetime3">2019年06月01日与2018年06月01日同比</div>
                    <div class="cell-content">
...
<script>
    ...
    function getHeadData(){
    	...
    	$.ajax({
			type : 'POST',
			url : "/enviromonit/water/wtDataServiceCompared/pollutionAnalysis",
			data : {
			    "pointCode" : pointName,
				"dataTime" : dataTime,
    ...
    function getCharts(){
    	...
    	if(isNoEmpty(dataTime)){
    		$.ajax({
                type : "GET",
                url : "/enviromonit/water/wtDataServiceCompared/getDataServiceCompared",
                async : false,
                dataType : "json",
                data : {
    				    "pointCode" : pointName,
