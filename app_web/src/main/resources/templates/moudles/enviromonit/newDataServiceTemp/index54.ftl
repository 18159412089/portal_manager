...
<div class="easyui-layout p10" >
    ...
    <div class="chart-group">
        ...
        <div class="data-info-layout ">
            <div class="other">
                ...
                <div class="inline-block">
                    <span class="control-label">监测站点：</span>
                    <span class="control-content">蓝田湖</span>
                </div>
            </div>
            <div class="row">
                <div class="item col-xs-4">
        ...
        <div class="chartBar">
            <div class="chart-box">
                <div id="airPrimaryPollutant2" style="width: 100%;height: 420px;"></div>
            </div>
        </div>
    ...
    <div class="chart-group">
        ...
        <div class="chartBar">
            <div class="chart-box">
                <div id="airPrimaryPollutant3" style="width: 100%;height: 420px;"></div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(function () {
        ...
        var airPrimaryPollutantChart2 = echarts.init(document.getElementById('airPrimaryPollutant2'));
        ...
        var airPrimaryPollutantChart3 = echarts.init(document.getElementById('airPrimaryPollutant3'));
        var airPrimaryPollutantOption3= {
            tooltip : {
                trigger: 'axis',
                axisPointer : {            // 坐标轴指示器，坐标轴触发有效
                    type : ''        // 默认为直线，可选为：'line' | 'shadow'
        ...
        airPrimaryPollutantChart3.setOption(airPrimaryPollutantOption3);
