...
<div class="easyui-layout p10" id="echartGroup">
    ...
    <div id="searchBar1" class="searchBar">
        <form id="searchForm1">
            ...
            <a href="javascript:void(0)" onclick="Ams.exportPdfById('echartGroup','AQI-超标天数')"
...
<script>
    ...
    var timeType = "AQICountDay";//查询的时间类型
    ...
    function getAQIEchartHtml(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            newRow += '<span class="em" id="currentAQINum' + data[i].pointCode + '">' + currentAQI + '</span>天'
            newRow += ' </div>';
            newRow += '</div>';
            newRow += '</div>';
            newRow += '</div>';
            ...
            newRow += '<div class="inline-block">';
            newRow += '<span>AQI：</span>';
            newRow += '<span class="em" id="oldAQINum' + data[i].pointCode + '">' + searchAQI + '</span>天';
            newRow += '</div>';
            newRow += '</div>';
            newRow += '</div>';
            newRow += '</div>';
            ...
            if (currentAQI < searchAQI) {
                newRow += '<span class="em down" id="subAQINum' + data[i].pointCode + '">' + Math.abs(currentAQI - searchAQI) + '</span>天';
            } else if (currentAQI > searchAQI) {
                newRow += '<span class="em up" id="subAQINum' + data[i].pointCode + '">' + Math.abs(currentAQI - searchAQI) + '</span>天';
            } else {
                newRow += '<span class="em" id="subAQINum' + data[i].pointCode + '">' + Math.abs(currentAQI - searchAQI) + '</span>天';
            }
            newRow += '</div>';
            newRow += '</div>';
            newRow += '</div>';
