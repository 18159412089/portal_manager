...
<div class="easyui-layout p10">
    ...
    <div id="searchBar1" class="searchBar">
        <form id="searchForm1">
            ...
            <a href="javascript:void(0)" onclick="Ams.exportPdfById('group0','优良天数(城市)-环比')"
                ...
                success: function (data) {
                    ...
                    for (var a in data) {
                        if (Ams.isNoEmpty(a) && data[a].length > 0) {
                            ...
                            var dayName = factor == 'excellent' ? '优天数：' : '良天数：';
