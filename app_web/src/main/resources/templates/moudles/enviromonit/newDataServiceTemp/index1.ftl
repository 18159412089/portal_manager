...
<script>
    ...
    function exportData(){
        ...
        window.open("${request.contextPath}/enviromonit/water/wtCityHourData/exportData?startTime="+startTime+"&endTime="+endTime+"&regionName="+regionName+"&type=0&category=2");
    }
    ////国考断面查询方法导出数据
    function exportData2(){
        ...
        window.open("${request.contextPath}/enviromonit/water/wtCityHourData/exportData?startTime="+startTime+"&endTime="+endTime+"&regionName="+regionName+"&type=0&category=1");
    }
</script>
</html>