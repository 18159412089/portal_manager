...
<body style="overflow:auto;">
			...
			<div class="map-panel-body" style="height: 545px;width:440px;position: relative;background: none;">
					...
					<div class="filter-container" style="margin-bottom: 12px;">
						<div class="filter-box">
							...
							<div class="filter-content">
								<div class="change-line no-choice" title="空气自建站点" id="miniMonitor" style="width: 130px" onclick="getMiniMonitor()">
									<img style="height:20px; width: 20px;float:left" src="/static/images/air/miniMonitor.png" />空气自建站点
								</div>
								...
								<div class="change-line no-choice" id="construction" title="工地" style="width:100px;" >
									<img style="height:20px; width: 20px;float:left" src="/static/images/air/site.png" />工地
								</div>
				...
				<div class="tabs-content" style="width:320px;margin-left:120px;top: 150px;">
					...
					<div class="body-box" id="mapTabs_enterprise"
						 url="/enterprise/peenterprisedata/list?outType=2">
						<div class="theme-container">
							<div class="theme-title">筛选</div>
							<div class="theme-content">
								<div class="search-container" id="enterpriseToolbar">
									<div class="search-box">
										...
										<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="enterpriseSearch()"></a>
									</div>
								</div>
								<div class="easyui-table-light">
							...
							<div class="theme-content">
								<div class="search-container" id="constructionToolbar">
									<div class="search-box">
										...
										<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="constructionSearch()"></a>
									</div>
								</div>
								<div class="easyui-table-light">
					...
					<div class="body-box" id="mapTabs_wpfqqy"
						 url="/enviromonit/airEnvironment/getPolluteList">
						<div class="theme-container">
							<div class="theme-title">筛选</div>
							<div class="theme-content">
								<div class="search-container" id="wpfqqyToolbar">
									<div class="search-box">
										...
										<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="wpfqqySearch()"></a>
									</div>
								</div>
								<div class="easyui-table-light">
								...
								<div class="search-container" id="gridCaseToolbar">
									<div class="search-box">
										...
										<div style="margin-top:7px;">
											...
											<a href="javascript:void(0)" title="搜索" class="easyui-linkbutton btn-primary" data-options="iconCls:'icon-search'" style="margin:0;" onclick="getAirCaseList()"></a>
										</div>
									</div>
								</div>
								<div class="easyui-table-light">
	...
	<script type="text/javascript" src="${request.contextPath}/static/js/moudles/enviromonit/air/airEnvironment.js"></script>
	...
	<script type="text/javascript" src="${request.contextPath}/static/js/moudles/enviromonit/air/enterpriseAnalysis.js"></script>
	<script type="text/javascript" src="${request.contextPath}/static/js/moudles/enviromonit/air/projectAnalysis.js"></script>
	<script type="text/javascript" src="${request.contextPath}/static/js/moudles/enviromonit/air/truckForbiddenArea.js"></script>
	<script type="text/javascript" src="${request.contextPath}/static/js/moudles/enviromonit/air/noFireworksArea.js"></script>
	<script type="text/javascript" src="${request.contextPath}/static/js/moudles/enviromonit/air/wpfqqyAnalysis.js"></script>
	<!-- 网格事件js -->
	...
	<script type="text/javascript" src="${request.contextPath}/static/js/moudles/enviromonit/air/airCase.js"></script>
	<script type="text/javascript">
		...
		$(function(){
			...
			$.ajax({
				type: 'POST',
				dataType : 'json',
				url: Ams.ctxPath+'/enviromonit/airMonitorPoint/getCity',
            ...
            if(airPointCode != ""){
                $.ajax({   
                    type: 'POST',
                    dataType : 'json',
                    url: Ams.ctxPath+'/enviromonit/airMonitorPoint/getPointsInfo',   
	...
	$(function(){
		...
		$("#yesterday").click(function () {
			...
			$.ajax({
				type: 'POST',
				dataType : 'json',
				url: Ams.ctxPath+'/enviromonit/airHourData/getAllPointsDayDataRanking',
				data: {time:Ams.dateFormat(day1, "yyyy-MM-dd") },
				success: function(data){
                    if(data.length == 0){
                        $("#yesterdayData").html("<li class='item'><span class='ranking'><span style='width:400px;'>暂无数据</span></span>");
                        return;
                    }
					var listHtml = "";
					$.each(data,function(i){
