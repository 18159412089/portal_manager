...
<div class="easyui-layout" fit=true>
    ...
    <table id="dg" class="easyui-datagrid" style="width:100%;height:auto;" toolbar="#toolbar"
           url="${request.contextPath}/enviromonit/rainMonthlyData/list" data-options="
            rownumbers:false,
            singleSelect:true,
            striped:true,
            autoRowHeight:false,
        ...
        <thead >
        <tr>
            <th field="time" width="120px">时间</th>
            <th field="days" width="120px">天数</th>
            <th field="sunshineDuration" width="60px" >日照时间（0.1h）</th>
            <th field="rainFall" width="250px">降雨量（0.1mm）</th>
        </tr>
        </thead>
    </table>
</div>
