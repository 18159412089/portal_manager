	...
	<div class="easyui-layout" fit=true>
		<div  id="toolbar">
			...
			<@sec.authorize access= "hasAuthority('enterprise:peenterprisedata:add')" > 
				<a href="javascript:void(0)" class="easyui-linkbutton btn-sky-blue" data-options="iconCls:'icon-add'" onclick="newPeEnterpriseData()">新增</a>
			</@sec.authorize>
			<@sec.authorize access= "hasAuthority('enterprise:peenterprisedata:edit')" > 
				<a href="javascript:void(0)" class="easyui-linkbutton btn-orange" data-options="iconCls:'icon-edit'" onclick="editPeEnterpriseData()">修改</a>
			</@sec.authorize>
			<@sec.authorize access= "hasAuthority('enterprise:peenterprisedata:delete')" > 
				<a href="javascript:void(0)" class="easyui-linkbutton btn-red" data-options="iconCls:'icon-remove'" onclick="deletePeEnterpriseData()">删除</a>
			</@sec.authorize>
		</div>
