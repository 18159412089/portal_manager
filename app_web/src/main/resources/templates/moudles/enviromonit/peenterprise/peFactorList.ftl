	...
	<div class="easyui-layout" fit=true>
		<div  id="toolbar">
			...
			<@sec.authorize access= "hasAuthority('factor:pefactor:add')" > 
				<a href="javascript:void(0)" class="easyui-linkbutton btn-sky-blue" data-options="iconCls:'icon-add'" onclick="newPeFactor()">新增</a>
			</@sec.authorize>
			<@sec.authorize access= "hasAuthority('factor:pefactor:edit')" > 
				<a href="javascript:void(0)" class="easyui-linkbutton btn-orange" data-options="iconCls:'icon-edit'" onclick="editPeFactor()">修改</a>
			</@sec.authorize>
			<@sec.authorize access= "hasAuthority('factor:pefactor:delete')" > 
				<a href="javascript:void(0)" class="easyui-linkbutton btn-red" data-options="iconCls:'icon-remove'" onclick="deletePeFactor()">删除</a>
			</@sec.authorize>
		</div>
