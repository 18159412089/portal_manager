...
<table id="dg" class="easyui-datagrid" style="width:100%px;height:auto" toolbar="#toolbar"
       url="${request.contextPath}/work/wait/todoList" data-options="
				rownumbers:false,
				singleSelect:true,
                striped:true,
				autoRowHeight:false,
    ...
    <thead>
    <tr>
	    <th field="actName" width="25%">流程名称</th>
	    <th field="name" width="25%">当前环节</th>
	    <th field="assignee" width="20%">当前处理人</th>
        <th field="createtime" width="20%" formatter="Ams.timeDateFormat">申请时间</th>
        <th field="assignee" width="20%" >操作</th>
    </tr>
    </thead>
</table>
...
<div id="dlg-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="createModel()" style="width:90px">创建</a>
