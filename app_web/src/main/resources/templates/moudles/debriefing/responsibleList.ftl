...
<div class="easyui-layout" fit=true style="padding-left:10px;padding-right:10px;">
    <div id="toolbar">
        ...
        <form id="uplodFile" method="post" enctype="multipart/form-data">
            <a href="javascript:void(0)" name="xlsxfile" id="importFile" class="easyui-filebox"
               data-options="accept:'application/vnd.ms-excel'"></a>
            <a href="javascript:void(0)" class="easyui-linkbutton btn-blue" data-options="iconCls:'icon-edit'" onclick="downloadFile()">责任名单模板</a>
        </form>
    </div>
