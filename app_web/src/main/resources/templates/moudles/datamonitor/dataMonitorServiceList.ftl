...
<div class="easyui-layout" fit=true>
            ...
            <form id="searchForm">
              ...
              <div class="inline-block">
               ...
               <div class="inline-block">
                   ...
                   <input id="querySourceDept" name="sourceDept" class="easyui-textbox"
                          style="width: 200px;">
               </div>
               <div class="inline-block">
                   <label class="textbox-label textbox-label-before" title="来源系统">来源系统:</label>
                   <input id="querySourceSystem" name="sourceSystem" class="easyui-textbox"
                          style="width: 200px;">
               </div>
                <div class="inline-block">
                    <label class="textbox-label textbox-label-before" title="集成方式">集成方式:</label>
                    <input id="queryIntegratiornWay" name="integratiornWay" class="easyui-textbox"
                           style="width: 200px;">
                </div>
               <div class="inline-block">
                   <label class="textbox-label textbox-label-before" title="更新频率">更新频率:</label>
                   <input id="queryUpdateFreq" name="updateFreq" class="easyui-textbox"
               ...
               <div class="inline-block">
                ...
                <a href="javascript:void(0)" class="easyui-linkbutton btn-red" data-options="iconCls:'icon-search'" onclick="doExport()">导出</a>
    ...
    <table id="dg" class="easyui-datagrid" tyle="width: 100%; height: auto;" toolbar="#toolbar"
           url="${request.contextPath}/dataMonitor/DataMonitor/dataMonitorServiceList"
           data-options="
					rownumbers:false,
					singleSelect:true,
					striped:true,
        ...
        <thead>
        <tr>
            <th formatter="Ams.tooltipFormat" field="serviceName" width="10%">业务名称</th>
            <th formatter="Ams.tooltipFormat" field="tableName" width="10%">表名称</th>
            <th formatter="Ams.tooltipFormat" field="sourceDept" width="10%">来源科室</th>
            <th formatter="Ams.tooltipFormat" field="sourceSystem" width="10%">来源系统</th>
        <#--<th field="integratiornWay" width="10%"> 集成方式</th>-->
            <th formatter="Ams.tooltipFormat" field="updateFreq" width="5%">更新频率</th>
            <th formatter="Ams.tooltipFormat" field="dataType" width="10%">数据类型</th>
            <th formatter="Ams.tooltipFormat" field="province" width="5%">省</th>
            <th formatter="Ams.tooltipFormat" field="city" width="5%">市</th>
            <th formatter="Ams.tooltipFormat" field="county" width="5%">县</th>
            <th formatter="Ams.tooltipFormat" field="numrows" width="20%">数据量</th>
            <th formatter="Ams.tooltipFormat" field="unit" width="20%">单位</th>
            <th formatter="Ams.tooltipFormat" field="lastddltime" width="20%">更新时间</th>
            <th formatter="Ams.tooltipFormat" field="isexception" width="20%">有误异常</th>
        </tr>
        </thead>
    </table>
</div>
...
<div id="dlg" class="easyui-dialog" style="width: 400px"
    ...
    <form id="fm" method="post" novalidate style="margin: 0; padding: 20px 50px">
        ...
        <div style="margin-bottom: 10px">
            <input name="province" id="province" class="easyui-textbox" required="true" label="省:" style="width: 100%"
                   data-options="">
        </div>
        <div style="margin-bottom: 10px">
...
<div id="dlg-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveDataMonitor()"
...
<script>
    ...
    function doSearch() {
        $('#dg').datagrid('load', {
            ...
            tableName: $("#queryTableName").val().trim(),
    ...
    function doExport() {
        window.location.href = "${request.contextPath}/dataMonitor/DataMonitor/dataMonitorServiceList?export=yes";
    }
