        ...
        <div class="nav-box">
            <ul class="nav-ul-tag" id="second">
                ...
                <li class="select-link">
                    <a href="${request.contextPath}/zphb/environment/rectifition/show?authority=1"
                       target="_self">
                        <i class="icon iconcustom icon-dubananjian1"></i>
                        <div class="title">总体情况</div>
                    </a>
                </li>
                <li>
                    <a href="${request.contextPath}/zphb/environment/rectifition/rectifitionListIntex?authority=1"
                       target="_self">
                        <i class="icon iconcustom icon-huanjing4"></i>
                        <div class="title">整改汇总表</div>
                    </a>
                </li>
                <#-- <li>
                    <a href="${request.contextPath}/zphb/enviromonit/distributeMap/map?authority=1"
                       target="_self">
                ...
                <li>
                    <a href="${request.contextPath}/zphb/environment/letterManage"
                       target="_self">
                        <i class="icon iconcustom icon-dubananjian1"></i>
                        <div class="title">信访管理</div>
                    </a>
                </li>
