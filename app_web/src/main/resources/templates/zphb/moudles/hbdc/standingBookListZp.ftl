        ...
        <div  style="display: inline-block; background-color: white;width: 100%; background-color: #f3f8f6;">
            <div style="padding:0px;border-bottom: none!important;" id="searchBar">
                <form id="searchForm">
                    ...
                    <a href="#" class="easyui-linkbutton btn-red" data-options="iconCls:'icon-arrow_refresh_small'" onclick="doReset()">重置</a>
                </form>
            </div>
        <@sec.authorize access="hasRole('ROLE_USER') OR hasRole('ROLE_ADMIN')">
            <a href="#" class="easyui-linkbutton btn-blue" id="newActach" data-options="iconCls:'icon-add'" onclick="newActach()">上传文件</a>
        </@sec.authorize>
        </div>
            ...
            onClickRow:function(rowIndex,rowData){
                 ...
                 if( f== 0) {
                     ...
                     $('#name').text('文件名称：')
                        ...
                        columns:[[
                            {field:'fileName',title:'文件名  &nbsp;&nbsp;&nbsp;上一级(<a href="#" onclick ="back()" style="cursor:hand">'+rowData.name+'<a/>)',width:80,formatter:newFile},
