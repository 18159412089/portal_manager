    ...
    <div id="toolbar">
        <div style="border-bottom: none" id="searchBar">
            <form id="searchForm" style="background-color: #f3f8f6;">
                <div style="width: 100%;text-align: center;"><font style="font-size: 180%;font-weight: bold !important;">漳浦县八闽快讯(一本账)总体情况汇总表</font>
            ...
            <#--<div id="message" style="width: 100%;text-align: center;font-size: 120%;font-weight: bold;color:white;background-color:#676767;"></div>-->
                ...
                <a href="#" style="position:relative; margin: 10px;float: left;" class="easyui-linkbutton btn-blue" data-options="iconCls:'icon-add'" onclick="addTask()">新增任务</a>
...
<script>
    ...
    function opera(val, row, index) {
        var uuid = row.uuid;
        return '<div>'+Ams.setImageSet()+'<a href="#" class="easyui-linkbutton" onclick="setStatus('+index+')">设置状态</a>'
