...
<body>
	...
	<div id="pf-bd">
		...
		<div id="pf-sider">
			...
			<!-- treegride -->
			<ul id="tg" class="easyui-tree" data-options="url:'${request.contextPath}/zphb/enter/mainPage/testData.do<#if type??>?type=${type!}</#if>'"></ul>
		</div>
		<!-- main -->
		<div id="pf-page">
			<div id="tabs" class="easyui-tabs1" border="false" style="height: 100%;"></div>
		</div>
	</div>
	<!-- menu -->
	...
	<script type="text/javascript">
		$(function () {
			...
			$('.pf-logo').html("<img src=\"/static/images/blocks1.png\" align=\"absmiddle\">  " + titleName);
			setTimeout(function(){
				$('#second li:first a').attr('href', '/zphb/index');
			}, 300);
		});
