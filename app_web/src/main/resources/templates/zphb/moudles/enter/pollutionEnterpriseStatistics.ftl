  ...
  <body style="overflow-y:hidden;overflow-x:hidden">
	...
	<div class="home-panel">
		...
		<div class="easyui-layout" fit=true>
			<table id="dg" class="easyui-datagrid" style="width: 100%; height: auto;" toolbar="#toolbar"
				   url="${request.contextPath}/zphb/enter/pollutionEnterpriseStatistics/getPollutionEnterpriseAllStatisticsListByCodeRegion"
				   data-options="
								rownumbers:false,
								singleSelect:true,
								striped:true,
	...
	<script type="text/javascript">
		...
		function getPollutionEnterpriseStatisticsByCodeRegion() {
			$.ajax({
				type: 'POST',
				url: Ams.ctxPath + '/zphb/enter/pollutionEnterpriseStatistics/getPollutionEnterpriseStatisticsByCodeRegion',
		...
		function getPollutionEnterpriseStatisticsByCodeEntertype() {
			$.ajax({
				type: 'POST',
				url: Ams.ctxPath + '/zphb/enter/pollutionEnterpriseStatistics/getPollutionEnterpriseStatisticsByCodeEntertype',
				success: function (data) {
