...
<div id="dlg" class="easyui-dialog" style="width:500px"
    ...
    <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px" enctype="multipart/form-data">
        ...
        <input id="source" name="source" value="wastewater" hidden/>
...
<script>
    ...
    function newActach() {
        ...
        url = Ams.ctxPath + '/zphb/enviromonit/distributeMap/save';
    }
    ...
    function doSearch() {
        $('#dg').datagrid({
            url: "/zphb/enviromonit/water/nationalSurfaceWater/getFileAttachPage",
            queryParams: {
