...
<div id="pf-hd">
    ...
    <div class="nav-container">
        ...
        <div class="nav-box">
            <ul class="nav-ul-tag" id="second" style="margin-top: 0px;">
                <li><a href="/index" target="_self"><i class="icon iconcustom icon-shouye1"></i><span class="title">首页</span></a></li>
                <li class="select-link"><a href="/enviromonit/water/nationalSurfaceWater?pid=d7aa1b75-6893-4091-8452-9c9a1ebf8369" target="_self"><i class="icon iconcustom icon-shidu1"></i><span class="title">水环境服务</span></a></li>
            </ul>
        </div>
        <div class="nav-menu-tag" style="display: none">
