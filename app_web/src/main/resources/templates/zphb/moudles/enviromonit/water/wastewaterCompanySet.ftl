...
<script>
    ...
    function toFilePage(value,row){
        return "<div>" + Ams.setImageSet() + "<a href= '/zphb/enviromonit/water/wastewaterFileAttachment?pid=" + $("#pid").val() + "&companyName=" + encodeURIComponent(row.qymc) + "' target='_blank' ass='easyui-linkbutton'>图片视频管理</a></div>";
    }
    ...
    function newActach() {
        ...
        url = Ams.ctxPath + '/zphb/enviromonit/water/nationalSurfaceWater/saveWasteCompanyInfo';
    }
    ...
    function editActach() {
        ...
        if (row) {
            ...
            $('#fm').form('load', row);
            url = Ams.ctxPath + '/zphb/enviromonit/water/nationalSurfaceWater/updateWastCompanyInfo';
        } else {
        ...
        if (row) {
            $.messager.confirm("提示信息", "确认删除当前选中的记录吗", function (r) {
                if (r) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: Ams.ctxPath + '/zphb/enviromonit/water/nationalSurfaceWater/deleteWasteCompanyInfo',
                        data: {
                            'qymc':row.qymc,
                            'wrwname':row.wrwname,
                            'year':row.year,
    ...
    function doSearch() {
        $('#dg').datagrid({
            url: "/zphb/enviromonit/water/nationalSurfaceWater/getWasteCompanyInfoPage",
            queryParams: {
