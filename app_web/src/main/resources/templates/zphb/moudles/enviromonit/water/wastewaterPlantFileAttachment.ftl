...
<div class="easyui-layout" fit=true >
    ...
    <div id="toolbar">
        <div style="padding:3px;" id="searchBar">
            <form id="searchForm">
                <label class="control-label">污水处理厂名称:</label>
                <input id="queryProjectName" name="name" value="${companyName!}" style="width:280px;"/>
        ...
        <a href="#" class="easyui-linkbutton btn-orange" data-options="iconCls:'icon-add'" onclick="newActach()" style="display: none">新增</a>
        <a href="#" class="easyui-linkbutton btn-blue" data-options="iconCls:'icon-edit'" onclick="editActach()">修改</a>
    ...
    <table id="dg" class="easyui-datagrid" style="width:100%;height:90%;" toolbar="#toolbar"
        ...
        <tr>
            ...
            <th field="qymc" width="120px" formatter="Ams.tooltipFormat">污水处理厂名称</th>
...
<div id="dlg" class="easyui-dialog" style="width:500px"
    ...
    <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px" enctype="multipart/form-data">
        ...
        <input id="source" name="source" value="wastewaterPlant" hidden/>
        <div style="margin-bottom:10px">
            <input id="projId" name="qymc" class="easyui-textbox"  style="width:200px;" label="企业名称:" disabled/>
        </div>
        <div style="margin-bottom:10px">
...
<script>
    ...
    function formatPic(value, row, index) {
        ...
        return "<div>" + Ams.setImageDown() + "<a href='/zphb/environment/waterAttachment/download/" + row.picture + "/2" +
    ...
    function doSearch() {
        $('#dg').datagrid({
            url: "/zphb/enviromonit/water/nationalSurfaceWater/getwastewaterPlantFileAttachPage",
            queryParams: {
