	...
	<div class="easyui-layout" fit=true>
		<div  id="toolbar">
			...
			<@sec.authorize access= "hasAuthority('hourData:peconhourdata:add')" > 
				<a href="#" class="easyui-linkbutton btn-sky-blue" data-options="iconCls:'icon-add'" onclick="newPeConHourData()">新增</a>
			</@sec.authorize>
			<@sec.authorize access= "hasAuthority('hourData:peconhourdata:edit')" > 
				<a href="#" class="easyui-linkbutton btn-orange" data-options="iconCls:'icon-edit'" onclick="editPeConHourData()">修改</a>
			</@sec.authorize>
			<@sec.authorize access= "hasAuthority('hourData:peconhourdata:delete')" > 
				<a href="#" class="easyui-linkbutton btn-red" data-options="iconCls:'icon-remove'" onclick="deletePeConHourData()">删除</a>
			</@sec.authorize>
		</div>
