                ...
                <div class="home-links-wrapper">
                    <div class="link-item">
                        <div class="home-links-box">
                            ...
                            <div class="link-text-box">
                                <a class="link-text" href="${request.contextPath}/zphb/enviromonit/water/nationalSurfaceWater?pid=1" target="_blank">
                    ...
                    <div class="link-item">
                        <div class="home-links-box">
                            ...
                            <div class="link-text-box">
                                <a class="link-text" href="${request.contextPath}/zphb/enviromonit/airEnvironment?pid=2" target="_blank">
                    ...
                    <div class="link-item">
                        <div class="home-links-box">
                            ...
                            <div class="link-text-box">
                                <a class="link-text" href="${request.contextPath}/zphb/environment/rectifition/show?authority=1" target="_blank">
                    ...
                    <div class="link-item">
                        <div class="home-links-box">
                            ...
                            <div class="link-text-box">
                                <a class="link-text" href="${request.contextPath}/zphb/zpCameraMap" target="_blank">
                    ...
                    <div class="link-item">
                        <div class="home-links-box">
                            ...
                            <div class="link-text-box">
                                <a class="link-text" href="${request.contextPath}/zphb/dataShow" target="_blank">
                    ...
                    <div class="link-item">
                        <div class="home-links-box">
                            ...
                            <div class="link-text-box">
                                <a class="link-text onclickUrl" href="javascript:;" linktarget="${request.contextPath}/zphb/enter/mainPage/main.do?type=ENTER&">
                    ...
                    <div class="link-item">
                        <div class="home-links-box">
                            ...
                            <div class="link-text-box">
                                <a class="link-text" href="https://140.237.73.123:8088/Epa/mainController?index" target="_blank">
                    ...
                    <div class="link-item">
                        <div class="home-links-box">
                            ...
                            <div class="link-text-box">
                                <a class="link-text onclickUrl" href="javascript:;" linktarget="${request.contextPath}/manage?">
...
<script type="text/javascript">
    $(function () {
        //企业信息  系统管理 增加中文参数处理
        $('.onclickUrl').on('click', function(){
            var url = $(this).attr("linktarget");
            var name = "漳浦生态汇聚平台";
            window.open(url+"titleName="+encodeURI(encodeURI(name)), '_blank');
        });
    });
