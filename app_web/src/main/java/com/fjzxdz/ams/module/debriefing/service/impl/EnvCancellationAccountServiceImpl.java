...
import com.fjzxdz.ams.module.debriefing.service.EnvCancellationAccountService;
...
public class EnvCancellationAccountServiceImpl implements EnvCancellationAccountService {

    @SuppressWarnings("unused")
    private static Logger logger = LogManager.getLogger(EnvCancellationAccountServiceImpl.class);
     ...
     * @param page
     * @return
     * @see com.fjzxdz.ams.module.debriefing.service.EnvCancellationAccountService#listByPage(com.fjzxdz.ams.module.debriefing.param.EnvCancellationAccountParam, cn.fjzxdz.frame.common.Page)
     */
    @Override
     ...
     * @param userDeptName
     * @return
     * @see com.fjzxdz.ams.module.debriefing.service.EnvCancellationAccountService#getEcharts(java.util.Date, java.util.Date)
     */
    @Override
    public JSONObject getEcharts(String startTime, String userDeptName) {
        ...
        if (StringUtils.isNotEmpty(userDeptName)) {
            sb.append(" and b.city_code = ").append(SqlUtil.toSqlStr(userDeptName));
        }
...
//				seriesDataList.add(1);
     ...
     * @param userDeptName
     * @return
     * @see EnvCancellationAccountService#getDescript(EnvCancellationAccountParam, String)
     */
    @SuppressWarnings("unchecked")
    @Override
    public R getDescript(EnvCancellationAccountParam param, String userDeptName) {
        JSONObject jsonObject = new JSONObject();
        String sql = "SELECT SCHEDULE,COUNTY_ACTUAL_TIME,CITY_ACTUAL_TIME,PROFESSION_ACTUAL_TIME,PROFESSION_EXAMINE_TIME FROM ENV_CANCELLATION_ACCOUNT a,ENVIRONMEENT_RECTIFITION b WHERE a.RECTIFITION_UUID = b.uuid ";
        if (ToolUtil.isNotEmpty(param.getProjectName())) {
            sql += " and a.NAME IN (SELECT UUID FROM COMMON_RELATION_TABLE WHERE NAME LIKE'%" + param.getProjectName() + "%')";
            if (ToolUtil.isNotEmpty(param.getDescribleName())) {
                sql += " AND a.DESCRIBE IN (SELECT UUID FROM COMMON_RELATION_TABLE WHERE NAME LIKE'%" + param.getDescribleName() + "%')";
            }
        } else if (ToolUtil.isNotEmpty(param.getDescribleName())) {
            sql += " and a.DESCRIBE IN (SELECT UUID FROM COMMON_RELATION_TABLE WHERE NAME LIKE'%" + param.getDescribleName() + "%')";
        }
        if (StringUtils.isNotEmpty(userDeptName)) {
            sql += " and b.city_code =  " + SqlUtil.toSqlStr(userDeptName);
        }
        sql += " and b.num <=100  ";
     ...
     * @param request
     * @return
     * @see EnvCancellationAccountService#getDecription(String, String, Page, HttpServletRequest)
     */
    @Override
     ...
     * @param page
     * @return
     * @see com.fjzxdz.ams.module.debriefing.service.EnvCancellationAccountService#getDetail(java.lang.String, cn.fjzxdz.frame.common.Page)
     */
    @Override
     ...
     * @param request
     * @return
     * @see EnvCancellationAccountService#getDecriptionAll(String, Page, HttpServletRequest)
     */
    @Override
...
//        }
     ...
     *
     * @param uuid
     * @see com.fjzxdz.ams.module.debriefing.service.EnvCancellationAccountService#deleteByUuid(java.lang.String)
     */
    @Override
