...
@Controller
@Scope("prototype")
@RequestMapping(value = "/enter/pollutionEnterpriseStatistics")
@Secured({ "ROLE_USER" })
public class PollutionEnterpriseStatisticsController extends BaseController {
	@Autowired
	...
	@RequestMapping("")
	public String index() {
		return "/moudles/" + "enter/pollutionEnterpriseStatistics";
	}
	...
	public JSONArray getPollutionEnterpriseStatisticsByCodeRegion() {
		...
		String sql = "SELECT" +
						" CASE" +
							...
							" '350627000000'" +
				" WHEN CODE_REGION = '350694000000' OR CODE_REGION = '350600030000' THEN '350694000000' "+
				" WHEN CODE_REGION = '350699000000' OR CODE_REGION = '350605000000' OR CODE_REGION = '350600020000' THEN '350699000000' "+
						" ELSE" +
							" CODE_REGION" +
						" END CODE_REGION," +
					" COUNT (*),Count(CORPCODE)" +
					" FROM" +
					" POLLUTION_ENTERPRISE_INFO" +
					" GROUP BY" +
					" CASE" +
						" WHEN CODE_REGION = '350690000000'" +
						" OR CODE_REGION = '350681000000' THEN" +
	...
	public JSONArray getPollutionEnterpriseAllStatisticsListByCodeRegion() {
		...
		String sql = "SELECT" +
				...
				" COUNT ( " +
				" CASE " +
				" WHEN CODE_ENTERTYPE = '第三产业' THEN " +
				"  '第三产业' " +
				" END " +
				"), " +
				" COUNT ( " +
				" CASE " +
				" WHEN CODE_ENTERTYPE = '小型企业' THEN " +
				"  '小型企业' " +
				" END " +
				"), " +
				" COUNT ( " +
				" CASE " +
				" WHEN CODE_ENTERTYPE = '畜禽养殖业' THEN " +
				"  '畜禽养殖业' " +
				" END " +
				"), " +
				" COUNT ( " +
				" CASE " +
				" WHEN CODE_ENTERTYPE = '污水处理厂' THEN " +
				"  '污水处理厂' " +
				" END " +
				"), " +
				" COUNT ( " +
				" CASE " +
				" WHEN CODE_ENTERTYPE = '一般工业企业' THEN " +
				"  '一般工业企业' " +
				" END " +
				"), " +
				" COUNT ( " +
				" CASE " +
				" WHEN CODE_ENTERTYPE = '建筑施工' THEN " +
				"  '建筑施工' " +
				" END " +
				"), " +
				" COUNT ( " +
				" CASE " +
				" WHEN CODE_ENTERTYPE = '' " +
				" OR CODE_ENTERTYPE IS NULL THEN " +
				"  '其他' " +
				" END " +
				")" +
				" FROM" +
	...
	public JSONArray getPollutionEnterpriseStatisticsByCodeEntertype() {
		...
		codeRegionMap.put("350606","高新技术开发区");
		codeRegionMap.put("350604","招商局经济技术开发区");
