package com.fjzxdz.ams.module.baseinfo.controller;
...
@Controller
@RequestMapping("/baseinfo/mainPage")
public class BaseInfoMainController extends BaseController {
	...
	public ModelAndView risk(@RequestParam(value = "type", required = false)String type, String menu, ModelAndView model, String pid) {
		...
		model.setViewName("/moudles/baseinfo/baseInfoMain");
		return model;
	}
