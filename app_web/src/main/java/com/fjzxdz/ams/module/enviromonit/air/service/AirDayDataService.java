 ...
 */
public interface AirDayDataService {
	 ...
	 * @throws
	 */
	Page<Map<String, Object>> listByPage(AirDayDataParam param, Page<Map<String, Object>> page, HttpServletResponse response);

	Page<Map<String, Object>> alllistByPage(AirDayDataParam param, Page<Map<String, Object>> page, HttpServletResponse response) ;
