...
public class EnvironmentDebriefingServiceImpl implements EnvironmentDebriefingService {

	@SuppressWarnings("unused")
	private static Logger logger = LogManager.getLogger(EnvironmentDebriefingServiceImpl.class);
