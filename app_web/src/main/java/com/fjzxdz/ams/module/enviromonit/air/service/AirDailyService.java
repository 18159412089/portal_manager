 ...
 */
public interface AirDailyService {
     ...
     */
    Page<Map<String, Object>> getTextAQIByPointName(AirDayDataParam param, String factor, String pointType, String timeType, Page<Map<String, Object>> page, HttpServletResponse response);
