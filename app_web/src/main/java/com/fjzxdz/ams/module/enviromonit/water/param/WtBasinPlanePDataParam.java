 ...
 * @version 2019-06-28
 */
public class WtBasinPlanePDataParam extends BaseQueryParam {
	...
	public WtBasinPlanePDataParam() {
		super(WtBasinPlanePData.class);
		this.clazz = WtBasinPlanePData.class;
	}
