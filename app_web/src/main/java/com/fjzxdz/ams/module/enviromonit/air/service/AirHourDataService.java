 ...
 */
public interface AirHourDataService {
	 ...
	 * @throws
	 */
	Page<Map<String, Object>> listByPage(AirHourDataParam param, Page<Map<String, Object>> page, HttpServletResponse response);
	 ...
	 * @throws
	 */
	List<Object[]> rankingOrderByAQI(String pointType, String pointCode, String deptName);
	...
	JSONArray getAllPointsDayDataRanking(String time, String deptName);


	/**
	 *
	 * @Title:  listByPage
	 * @Description:    查询空气小时数据(无处理数据)
	 * @CreateBy: zhongyunlong
	 * @CreateTime: 2019年5月9日 下午2:29:19
	 * @UpdateBy: zhongyunlong
	 * @UpdateTime:  2019年5月9日 下午2:29:19
	 ...
	 * @throws
	 */
	Page<Map<String, Object>> alllistByPage(AirHourDataParam param, Page<Map<String, Object>> page, HttpServletResponse response);
