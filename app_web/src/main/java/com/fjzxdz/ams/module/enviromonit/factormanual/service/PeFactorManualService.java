 ...
 */
package com.fjzxdz.ams.module.enviromonit.factormanual.service;
...
public class PeFactorManualService {

	@SuppressWarnings("unused")
	private static Logger logger = LogManager.getLogger(PeFactorManualService.class);
