 ...
 */
package com.fjzxdz.ams.module.enviromonit.factormanual.controller;
...
@Controller
@Scope("prototype")
@RequestMapping(value = "/factormanual/PeFactorManual")

public class PeFactorManualController extends BaseController {
	...
	@RequestMapping("")
	public String index() {
		return "/enviromonit/" + "factormanual/peFactorManualList";
	}
