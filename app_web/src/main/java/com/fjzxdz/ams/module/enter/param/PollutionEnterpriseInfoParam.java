 ...
 */
package com.fjzxdz.ams.module.enter.param;
 ...
 * @version 2019-02-26
 */
public class PollutionEnterpriseInfoParam extends BaseQueryParam {
	...
	public PollutionEnterpriseInfoParam() {
		super(PollutionEnterpriseInfo.class);
		this.clazz = PollutionEnterpriseInfo.class;
	}
	...
	protected void createQueryClauses() {
		addClause("codeAttentiondegree", getCodeAttentiondegree(), SearchCondition.LIKE);
		addClause("entercode", getEntercode(), SearchCondition.LIKE);
		addClause("envinvestmoneytype", getEnvinvestmoneytype(), SearchCondition.LIKE);
		addClause("codeEntertype", getCodeEntertype(), SearchCondition.LIKE);
		addClause("psenvironmentdept", getPsenvironmentdept(), SearchCondition.LIKE);
		addClause("codeUnittypecode", getCodeUnittypecode(), SearchCondition.LIKE);
		addClause("createtime", getCreatetime(), SearchCondition.LIKE);
		addClause("latitude", getLatitude(), SearchCondition.LIKE);
		addClause("website", getWebsite(), SearchCondition.LIKE);
		addClause("codeControllevel", getCodeControllevel(), SearchCondition.LIKE);
		addClause("moneytype", getMoneytype(), SearchCondition.LIKE);
		addClause("codeIndustryareaname", getCodeIndustryareaname(), SearchCondition.LIKE);
		addClause("standenterid", getStandenterid(), SearchCondition.LIKE);
		addClause("postalcode", getPostalcode(), SearchCondition.LIKE);
		addClause("codeEntersize", getCodeEntersize(), SearchCondition.LIKE);
		addClause("enteraddress", getEnteraddress(), SearchCondition.LIKE);
		addClause("entername", getEntername(), SearchCondition.LIKE);
		addClause("environtel", getEnvirontel(), SearchCondition.LIKE);
		addClause("bankname", getBankname(), SearchCondition.LIKE);
		addClause("email", getEmail(), SearchCondition.LIKE);
		addClause("environphone", getEnvironphone(), SearchCondition.LIKE);
		addClause("corpcode", getCorpcode(), SearchCondition.LIKE);
		addClause("historyentername", getHistoryentername(), SearchCondition.LIKE);
		addClause("environinvest", getEnvironinvest(), SearchCondition.LIKE);
		addClause("fax", getFax(), SearchCondition.LIKE);
		addClause("environmentmans", getEnvironmentmans(), SearchCondition.LIKE);
		addClause("bankcode", getBankcode(), SearchCondition.LIKE);
		addClause("companyname", getCompanyname(), SearchCondition.LIKE);
		addClause("communicateaddr", getCommunicateaddr(), SearchCondition.LIKE);
		addClause("trade", getTrade(), SearchCondition.LIKE);
		addClause("dutyperson", getDutyperson(), SearchCondition.LIKE);
		addClause("environlinkmen", getEnvironlinkmen(), SearchCondition.LIKE);
		addClause("regionname", getRegionname(), SearchCondition.LIKE);
		addClause("telephone", getTelephone(), SearchCondition.LIKE);
		addClause("totalinvest", getTotalinvest(), SearchCondition.LIKE);
		addClause("codeTrade", getCodeTrade(), SearchCondition.LIKE);
		addClause("codeRegion", getCodeRegion(), SearchCondition.LIKE);
		addClause("corpname", getCorpname(), SearchCondition.LIKE);
		addClause("codeRegistertype", getCodeRegistertype(), SearchCondition.LIKE);
		addClause("linkman", getLinkman(), SearchCondition.LIKE);
		addClause("codeEnterrelation", getCodeEnterrelation(), SearchCondition.LIKE);
		addClause("shortname", getShortname(), SearchCondition.LIKE);
		addClause("codeQualification", getCodeQualification(), SearchCondition.LIKE);
		addClause("longitude", getLongitude(), SearchCondition.LIKE);
		addClause("wsystem", getWsystem(), SearchCondition.LIKE);
		addClause("environfax", getEnvironfax(), SearchCondition.LIKE);
