...
import com.fjzxdz.ams.module.debriefing.service.EnvironmentDebriefingService;
...
@Controller
@RequestMapping("/environment/debriefing")
@Secured({ "ROLE_USER" })
//@Secured({ "ROLE_ADMIN", "ROLE_ROOT" })
public class EnvironmentDebriefingController extends BaseController {

	@Autowired
	private EnvironmentDebriefingService debriefingService;
	...
	@RequestMapping("/show")
	public String show() {
		return "/moudles/debriefing/environmentDebriefingShow";
	}
