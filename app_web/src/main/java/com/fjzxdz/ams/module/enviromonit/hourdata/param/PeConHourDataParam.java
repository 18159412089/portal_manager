 ...
 */
package com.fjzxdz.ams.module.enviromonit.hourdata.param;
 ...
 * @date 2019-02-11
 */
public class PeConHourDataParam extends BaseQueryParam {
	...
	public PeConHourDataParam() {
		super(PeConHourData.class);
		this.clazz = PeConHourData.class;
	}
