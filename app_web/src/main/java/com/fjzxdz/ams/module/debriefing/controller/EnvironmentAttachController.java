...
@Controller
@RequestMapping("/environment/attach")
@Secured({ "ROLE_USER" })
/**
 * 
 ...
 */
public class EnvironmentAttachController extends BaseController {
	...
	@Autowired
	private CommonTaskTableService commonTaskTableService;
	
	@Autowired
	private CommonRelationTableService commonRelationTableService;
	...
	private ModelAndView environmentAttachTask(ModelAndView modelAndView,String authority,String pid) {
		...
		modelAndView.setViewName("/moudles/debriefing/environmentAttachTaskTable");
		return modelAndView;
	}
	
	@RequestMapping("/environmentAttachAddTask")
	private String environmentAttachAddTask() {
		return "/moudles/debriefing/environmentAttachAddTask";
	}
	...
	public ModelAndView environmentAttachDisplay(ModelAndView modelAndView,String authority,String pid) {
		modelAndView.addObject("authority", authority);
		modelAndView.addObject("pid", pid);
		modelAndView.setViewName("/moudles/debriefing/environmentAttachDisplay");
		return modelAndView;
	}
