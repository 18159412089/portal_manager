 ...
 */
package com.fjzxdz.ams.module.enviromonit.enterprise.param;
 ...
 * @date 2019-02-11
 */
public class PeEnterpriseDataParam extends BaseQueryParam {
	...
	public PeEnterpriseDataParam() {
		super(PeEnterpriseData.class);
		this.clazz = PeEnterpriseData.class;
	}
