...
public interface EnvCancellationAccountService {

    Page<EnvCancellationAccount> listByPage(EnvCancellationAccountParam param, Page<EnvCancellationAccount> page);

    JSONObject getEcharts(String startTime, String userDeptName);

	R getDescript(EnvCancellationAccountParam param, String userDeptName);
