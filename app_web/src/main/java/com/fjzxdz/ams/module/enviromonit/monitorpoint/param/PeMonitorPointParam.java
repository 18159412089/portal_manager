 ...
 */
package com.fjzxdz.ams.module.enviromonit.monitorpoint.param;
 ...
 * @date 2019-02-11
 */
public class PeMonitorPointParam extends BaseQueryParam {
	...
	public PeMonitorPointParam() {
		super(PeMonitorPoint.class);
		this.clazz = PeMonitorPoint.class;
	}
