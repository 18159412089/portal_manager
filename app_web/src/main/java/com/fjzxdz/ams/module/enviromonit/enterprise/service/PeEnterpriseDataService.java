 ...
 */
package com.fjzxdz.ams.module.enviromonit.enterprise.service;
...
public class PeEnterpriseDataService {

	@SuppressWarnings("unused")
	private static Logger logger = LogManager.getLogger(PeEnterpriseDataService.class);
