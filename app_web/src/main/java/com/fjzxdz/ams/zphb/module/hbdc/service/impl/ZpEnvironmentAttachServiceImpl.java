...
public class ZpEnvironmentAttachServiceImpl implements ZpEnvironmentAttachService {

	@SuppressWarnings("unused")
	private static Logger logger = LogManager.getLogger(ZpEnvironmentAttachServiceImpl.class);
