 ...
 */
package com.fjzxdz.ams.zphb.module.enviromonit.rubbish.entity;
 ...
 */
@Entity
@Table(name = "ZP_POLLUTION_TRANSFER_STATION")
public class ZpTransferStation implements Serializable {
