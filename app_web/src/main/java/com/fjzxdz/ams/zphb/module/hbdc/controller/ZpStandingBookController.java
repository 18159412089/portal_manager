 ...
 */
@Controller
@RequestMapping("/zphb/debrief/StandingBook")
@Secured({ "ROLE_USER" })
public class ZpStandingBookController extends BaseController {

	@Autowired
	private ZpStandingBookService standingBookService;
	...
	public ModelAndView index(ModelAndView modelAndView,String authority,String pid) {
		...
		modelAndView.setViewName("/moudles/debriefing/standingBookListZp");
		return modelAndView;
	}
