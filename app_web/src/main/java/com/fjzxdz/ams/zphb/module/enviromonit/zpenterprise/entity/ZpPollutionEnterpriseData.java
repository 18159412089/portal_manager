package com.fjzxdz.ams.zphb.module.enviromonit.zpenterprise.entity;
 ...
 */
@Entity
@Table(name = "ZP_POLLUTION_ENTERPRISE_DATA")
public class ZpPollutionEnterpriseData implements Serializable {
	...
	@JsonIgnore
    @OneToMany(fetch = FetchType.LAZY ,mappedBy ="zpPeEnterpriseData")
	@NotFound(action=NotFoundAction.IGNORE)
	private Set<ZpPeMonitorPoint> zpPeMonitorPoint = new HashSet<ZpPeMonitorPoint>();
	
	@Transient
	private List<ZpPeMonitorPoint> zpPeMonitorPointList;
	
	public Set<ZpPeMonitorPoint> getZpPeMonitorPoint() {
		return zpPeMonitorPoint;
	}

	public void setPeMonitorPoint(Set<ZpPeMonitorPoint> zpPeMonitorPoint) {
		this.zpPeMonitorPoint = zpPeMonitorPoint;
	}
	...
	public List<ZpPeMonitorPoint> getZpPeMonitorPointList() {
		return zpPeMonitorPointList;
	}

	public void setZpPeMonitorPointList(List<ZpPeMonitorPoint> zpPeMonitorPointList) {
		this.zpPeMonitorPointList = zpPeMonitorPointList;
	}
