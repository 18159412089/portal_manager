...
public class ZpPeConHourDataService {

	@SuppressWarnings("unused")
	private static Logger logger = LogManager.getLogger(ZpPeConHourDataService.class);

	@Autowired
	private ZpPeConHourDataDao peConHourDataDao;
	@Autowired
	 ...
	 * @return
	 */
	public Page<ZpPeConHourData> listByPage(ZpPeConHourDataParam zpPeConHourDataParam, Page<ZpPeConHourData> page) {
		Page<ZpPeConHourData> listPage = peConHourDataDao.listByPage(zpPeConHourDataParam, page);
		return listPage;
	}
	 ...
	 * @param peConHourData
	 */
	public void save(ZpPeConHourData peConHourData) {
		if (StringUtils.isNotEmpty(peConHourData.getPeId())) {
			ZpPeConHourData peConHourDataTemp = peConHourDataDao.getById(peConHourData.getPeId());
			...
			peConHourData = (ZpPeConHourData) EmptyStringToNullUtil.emptyStringToNull(peConHourData);
	 ...
	 * @param outputId
	 */
	public List<ZpPeConHourData> getPeConHourDataListByOutputId(String outputId, Timestamp queryMeasureStartTime, Timestamp queryMeasureEndTime, int page, int pageSize) {
	 ...
	 * 导出
	 * @param outputId
	 * @param queryMeasureStartTime
	 * @param queryMeasureEndTime
	 * @return
	 */
	public JSONObject getPeConHourDataListByOutputIdExport(String outputId, String queryMeasureStartTime, String queryMeasureEndTime) {
		...
		try {
			...
			for(int i=0;i<peConHourDataObjList.size();i++) {
				...
				if (!com.alibaba.druid.util.StringUtils.isEmpty(peConHourDataObj[3].toString()) && !com.alibaba.druid.util.StringUtils.isEmpty(peConHourDataObj[5].toString())){
