...
import com.fjzxdz.ams.zphb.module.enviromonit.air.service.ZpAirDayDataService;
...
public class ZpAirDayDataServiceImpl implements ZpAirDayDataService {
     ...
     *
     * @return
     * @see AirDayDataService#airQuantityForLastMonth()
     */
     ...
     * @param endTime
     * @return
     * @see AirDayDataService#getCityByMonth(String, String, String)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @param time
     * @return
     * @see AirDayDataService#getCityAirInfo(String, String)
     */
    @SuppressWarnings("unchecked")
    @Override
