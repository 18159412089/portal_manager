...
import com.fjzxdz.ams.zphb.module.hbdc.service.ZpEnvironmentDebriefDetailsService;
...
@Controller
@RequestMapping("/zphb/environment/debrief/details")
@Secured({ "ROLE_USER" })
public class ZpEnvironmentDebriefDetailsController extends BaseController {

	@Autowired
	private ZpEnvironmentDebriefDetailsService detailsService;
	...
	public String index(String uuid, Model model) {
		...
		return "/zphb/moudles/hbdc/environmentDebriefDetailsList";
	}
