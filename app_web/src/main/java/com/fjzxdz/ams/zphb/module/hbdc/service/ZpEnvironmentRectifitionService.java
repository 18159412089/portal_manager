...
public interface ZpEnvironmentRectifitionService {

	Page<EnvironmentRectifition> listByPage(EnvironmentRectifitionParam param, Page<EnvironmentRectifition> page);

	List<EnvironmentRectifitionChart> getProjectCountByCity(String status, String startTime, String endTime);
	...
	JSONObject getEcharts(String startTime, String endTime);

	JSONObject getPieEcharts(String startTime, String endTime);
	 ...
	 * @throws 
	 */ 
	Page<Map<String, Object>> getDecriptionAll(String status, String startTime, String endTime, Page<Map<String, Object>> page);
