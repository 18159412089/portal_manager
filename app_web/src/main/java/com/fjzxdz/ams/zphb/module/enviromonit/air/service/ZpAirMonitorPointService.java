 ...
 */
public interface ZpAirMonitorPointService {
	 ...
	 * @throws
	 */
	List<Object[]> getCityByType(String type, String pointCode, String factor);
	 ...
	 * @throws
	 */
	List<AirMonitorPoint> getPointByType(String type);
