...
@Component("airHourDataSyncTask")
public class AirHourDataSyncTask {

    private static Logger logger = LogManager.getLogger(AirHourDataSyncTask.class);
    ...
    public void syncData() throws Exception {
		...
		try {
			...
			logger.info("同步空气小时数据失败:"+e.getMessage());
			throw e;
		} finally {
			if(proc!=null) {
				proc.close();
    ...
    private void getData(JSONObject queryObject, Connection conn, CallableStatement proc, String endpoint) throws Exception {
		...
		String result = (String) call.invoke(new Object[] { "4028838963ca04410163fd701b7b5f06","3506",queryObject.toString() });  
		// 给方法传递参数，并且调用方法  
