...
public class NumUtil {
     ...
     * @return double
     */
    public static Double divide(double v1, double v2,int cale) {
        BigDecimal n1 = new BigDecimal(Double.toString(v1));
        BigDecimal n2 = new BigDecimal(Double.toString(v2));
        if (v2!=BigDecimal.ZERO.doubleValue()){
            return n1.divide(n2, cale, BigDecimal.ROUND_HALF_UP).doubleValue();
        }
    ...
    public static void main(String[] args) {
        System.out.println(divide(20.3, 0.0,4));
    }
