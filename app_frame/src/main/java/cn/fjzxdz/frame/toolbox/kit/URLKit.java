...
import cn.fjzxdz.frame.toolbox.exception.ToolBoxException;
...
public class URLKit {
     ...
     * @return URL
     * @throws ToolBoxException MalformedURLException
     */
     ...
     * @param charset 编码
     * @return 编码后的URL
     * @throws ToolBoxException UnsupportedEncodingException
     */
     ...
     * @param uriStr URI路径
     * @return path
     * @throws ToolBoxException URISyntaxException
     */
